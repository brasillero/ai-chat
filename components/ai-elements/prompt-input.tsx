...
// ---------------------------------------------------------------------------
// Event-type aliases derived from the installed ui primitives.
// (This registry file was generated against a different @base-ui/react
// version; deriving the types keeps it compiling against @base-ui/react 1.6.)
// ---------------------------------------------------------------------------
...
// Note: @base-ui/react 1.6 PreviewCard has no delay props, so this is a
// plain pass-through (the registry version passed openDelay/closeDelay).
